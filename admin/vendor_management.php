...
if(isset($_GET['type']) && $_GET['type']!=''){
	...
	if($type=='status'){
		...
		print_r("<script > alert('Operation  Successful'); window.location.href='vendor_management.php';</script>");
	}
						 ...
						 <tbody>
							...
							<tr>
							   ...
							   <td>
								...
								?>
								<span class="badge badge-delete"><a href="?type=delete&id=<?=$row['id']?>"  onClick="return confirm('Do you really want to delete');">Delete</a></span>
							   </td>
							</tr>
							<?php $i++;} ?>
						 </tbody>
