...
<html class="no-js" lang="">
   ...
   <head>
      ...
      <link rel="icon" type="image/x-icon" href="../img/glamcos.png">
         ...
         <nav class="navbar navbar-expand-sm navbar-default">
            <div id="main-menu" class="main-menu collapse navbar-collapse">
               <ul class="nav navbar-nav">
                  ...
                  <li class="menu-item-has-children dropdown">
                     <a href="vendor_management.php" > Vendor Master</a>
                  </li>
				  <li class="menu-item-has-children dropdown">
                     <a href="banner.php" > Banner</a>
                  </li>
				  <li class="menu-item-has-children dropdown"> <a href="categories.php" > Categories Master</a> </li>
         ...
         <header id="header" class="header">
            <div class="top-left">
               <div class="navbar-header">
                  <a class="navbar-brand" href="index.php"><img src="../art/logo.png" alt="Logo" style="max-width: 110px;"></a>
                  <a class="navbar-brand hidden" href="index.php"><img src="../img/logo.png" alt="Logo"></a>
