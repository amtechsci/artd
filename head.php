...
if (isset($_SESSION['user'])) {
        ...
        $user = towfetch($uf);
        $cart = townum(towquery("SELECT * FROM carts WHERE customer_id='{$user['id']}'"));
      ...
      <header class="site-header" role="banner">
          <div class="nav-header" id="nav-head">
            <div class="page-width">
              ...
              <span class="d-none d-md-block" style="position: absolute; top: 5px; right: 30px; font-size: 20px; cursor:pointer;"  onclick="document.getElementById('nav-head').style.display = 'none';">x</span>
            </div>
          </div>
                  ...
                  <div class="page-width">
                    ...
                    <div class="header-user-selection col-md-2 hidden-lg-down">
                      ...
                      <div id= "_desktop_user_info" class="user_info full-width hidden-lg-down ">
                        <a href="<?php if(isset($user)){echo "/profile.php";}else{ echo "/login.php";} ?>" class="userinfo-title">
                ...
                <div class="header-logo-section" style="display:inline;">
                    <h1 class="h2 header__logo" style="display:inline;">
                        <a href="index.php" class="header__logo-image" style="display:inline;">
                            <img src="art/logo.png" style="width:25%;padding:5px 0;">
                        </a>
                    </h1>
                </div>
                
                <div class="header-user-selection col-md-2">
                      <a href="/cart.php"><div id= "_desktop_cart" class="">
                        <div class="cart-display">
                          <div class="cart-title clearfix collapsed" data-target="#cart-container" data-toggle="collapse">
                            <div class="site-header__cart expand-more">
                    ...
                    <div id="_desktop_search" class="site-header__search  ">
                      <div class="search-title clearfix collapsed" data-target="#search-container-fullm" data-toggle="collapse">
                        <span class="search-toggle hidden-lg-down">
                            <svg xmlns="http://www.w3.org/2000/svg" style="display: none;">   
                              <symbol id="magnifying-desktop" viewBox="0 0 1200 1200"><title>magnifying-desktop</title>
                                <path d="M606.209,578.714L448.198,423.228C489.576,378.272,515,318.817,515,253.393C514.98,113.439,399.704,0,257.493,0
                      ...
                      <div  id="search-container-fullm" class="search-info collapse">
                          <form action="/shop.php" method="get" class="search-header search search--focus" role="search">
                            <input class="search-header__input search__input" type="search" name="q" placeholder="Search Our Catalog" aria-label="Search Our Catalog">
                            <button class="search-header__submit search__submit btn--link" type="submit">
                              <span class="search-logo"> <i class="material-icons">search</i> </span>
          ...
          <div class="nav-bar">
                          <ul class="nav-bar-list">
                            <li><a href="/"><i class="fas fa-user" style="width:30px"></i> Home</a></li>
                            <li><a href="about-us.php"><i class="fas fa-info" style="width:30px"></i> About</a></li>
                            <li><a href="shop.php"><i class="fas fa-shopping-cart" style="width:30px"></i> Shop</a></li>
                            <li><a href="contact.php"><i class="fas fa-id-card-alt" style="width:30px"></i> Contact</a></li>
